# NOTES — corpus `collect-240926-hardwarecooking`

## Génération

Mode **files** (`RAG/_tools/build_rag.py`) : **une source = un chunk**, copie verbatim.

- source : `docs/RAG/clean_en/hardwarecooking` (12 fichiers)
- dossier interne : `hardwarecooking` · domaine : hardwarecooking (100 %)
- total : ~15,107 mots

## Contenu

HardwareCooking — montage PC, matériel et configures.

## Titres

12 fichier(s) sur 12 n'ont pas de titre `# H1` dans la source : le titre
