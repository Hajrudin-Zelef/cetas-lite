---
id: collect-240926-tomshardware/tomshardware/amd-working-on-new-x3d-v-cache-mobile-chip-for-gaming-laptops-leaker-claims-ryze
title: "amd-working-on-new-x3d-v-cache-mobile-chip-for-gaming-laptops-leaker-claims-ryze"
domain: tomshardware
role: reference
task: reference
actors: ["AMD", "Google"]
dates: []
keywords: ["amd", "cost"]
source: docs/RAG/clean_en/tomshardware/amd-working-on-new-x3d-v-cache-mobile-chip-for-gaming-laptops-leaker-claims-ryze.md
source_anchor: ""
source_lines: [1, 28]
sha256: de2ed4660abe06f738066e7fcf50cfbcdb8e54e9fc8d4b45b06ee1428b04b3f4
---

# amd-working-on-new-x3d-v-cache-mobile-chip-for-gaming-laptops-leaker-claims-ryze

<!-- source: https://www.tomshardware.com/pc-components/cpus/amd-working-on-new-x3d-v-cache-mobile-chip-for-gaming-laptops-leaker-claims-ryzen-7-9800hx3d-could-launch-with-8-cores-16-threads-and-96mb-cache -->
...
- 
To the extent that gaming laptops make sense, here's a good product for them. You don't need 12-16 cores.Reply
 
Your maximum FPS may not be affected at all by having Zen 5 X3D inside, but it's likely to be more efficient than other 45-55W options.
- 
ReplyYour maximum FPS may not be affected at all by having Zen 5 X3D inside, but it's likely to be more efficient than other 45-55W options. FPS might be on the table if a thirsty "gaming" CPU is hitting it's TDP limit or being thermal-throttled; if nothing else, I agree that the efficiency advantage of X3D in gaming results in quieter, cooler, and more efficient gaming sessions for laptop gamers, with maybe a small FPS advantage in some cases for RTX 90-class users.
 
Either way, FPS-per-watt should be unrivaled, yep.
