---
id: collect-240926-tomshardware/tomshardware/intel-core-ultra-7-270k-plus-review-back-from-the-brink
...
dates: []
keywords: ["intel", "amd", "benchmark", "benchmarks", "compute", "consumer", "memory", "pricing", "wafer"]
source: docs/RAG/clean_en/tomshardware/intel-core-ultra-7-270k-plus-review-back-from-the-brink.md
source_anchor: ""
source_lines: [1, 109]
sha256: ab1fa727295737e4c07082f39c03e8313ddf16dc11bfd8a3c28cd52d8c005f3f
---

# intel-core-ultra-7-270k-plus-review-back-from-the-brink

<!-- source: https://www.tomshardware.com/pc-components/cpus/intel-core-ultra-7-270k-plus-review -->
...
In applications, the Core Ultra 7 270K is hard to believe– so difficult, in fact, that I had to rerun applications on the full Arrow Lake stack to make sure my numbers were correct. In games, it’s decent. Intel is able to squeeze out a marginal lead over AMD’s competing __Ryzen 7 9700X__, but AMD’s X3D offerings still hold a solid lead, though at a much higher price.
...
We’ve also tested the Core Ultra 5 250K Plus, and you’ll see that testing reflected in our geomeans below. Our full Core Ultra 5 250K Plus review is live if you're interested in learning more about that chip.
...
With __Intel’s Core 200S Boost__ on Z-series motherboards, both the fabric and die-to-die frequency can climb to 3.2 GHz, regardless of whether you’re using a stock Arrow Lake or Plus chip. So, stock Arrow Lake chips can recover some of the performance on display here. Critically for the Plus parts is that you’re getting within 200 MHz of the boost profile out of the box. You don’t need a specific motherboard to leverage the improved speeds.
