---
id: collect-240926-tomshardware/tomshardware/hot-chips-2026-ibm-s-first-dual-isa-core-natively-executes-arm-and-z-architectur
title: "hot-chips-2026-ibm-s-first-dual-isa-core-natively-executes-arm-and-z-architectur"
domain: tomshardware
role: reference
task: reference
actors: ["Apple"]
dates: []
keywords: ["2nm", "accelerator", "bedrock", "consumer", "fp4", "memory", "mxfp4"]
source: docs/RAG/clean_en/tomshardware/hot-chips-2026-ibm-s-first-dual-isa-core-natively-executes-arm-and-z-architectur.md
source_anchor: ""
source_lines: [1, 56]
sha256: 667a0040a2b22e070f92165284df4c30d6b44a09f172982d10ac50b9ef3c9243
---

# hot-chips-2026-ibm-s-first-dual-isa-core-natively-executes-arm-and-z-architectur

<!-- source: https://www.tomshardware.com/pc-components/cpus/ibms-first-dual-isa-core-natively-executes-arm-and-z-architecture-in-the-same-core-all-cores-run-at-5-7-ghz-base-frequency-next-gen-mainframe-ai-processor-is-built-on-2nm-node-with-11-cores -->
...
- 
Yikes, can't wait to see that price tag with the accelerators going from LPDDR5 to HBM3e. Maybe Z18 mainframes will offer a bigger enough perf uplift to really consolidate on the number of mainframes needed? Guess that's already true in large part due to the new dual-ISA cores.Reply
- 
IBM is in the long game, for long-term customers. This is the latest in a long line since the System/360 in 1964 -- 62 years ago.Reply
 
 IBM already has its own RISC architecture in POWER/PowerPC (they merged back into one architecture some years back).
 I wonder if the choice of ARM was a technical decision, a political decision or a marketing decision.
For one thing, Apple having transitioned Mac away from PowerPC to later focus on ARM might have tainted the POWER brand.
- 
I've thought it would be interesting to sneak dual-ISA (separate cores) into x86 consumer chips. Like quad-core Cortex-A520++. Chiplets could make it easier.Reply
 
It does show up in some places, like the Pico 2.
