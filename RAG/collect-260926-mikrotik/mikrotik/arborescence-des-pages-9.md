---
id: collect-260926-mikrotik/mikrotik/arborescence-des-pages-9
title: "Summary"
domain: mikrotik
role: reference
task: reference
actors: []
dates: []
keywords: ["agent", "agents", "cost"]
source: docs/RAG/lot-mikrotik/RouterOS/arborescence-des-pages-9.md
source_anchor: ""
source_lines: [1, 86]
sha256: b8e4537db344ce397c05c1b5c6cd942ce5cfe1d53532177880682354c072c907
---
...
| **secrets** (*string* ; Default: )*sensitive* | List of global secrets used for RoMON message hashing. | 
...
| **secrets** (*string* ; Default: )*sensitive* | List of individual port secrets used for RoMON message hashing. | 
