---
id: collect-260926-mikrotik/mikrotik/how-to-connect-to-routeros-devices-with-ssh
...
dates: []
keywords: ["memory"]
source: docs/RAG/lot-mikrotik/RouterOS/how-to-connect-to-routeros-devices-with-ssh.md
source_anchor: ""
source_lines: [1, 94]
sha256: cb01efd525137e4a878376b5928790ca44973c3eddffda60658578c951f20134
---
...
2. The community.routeros.command module does not support nesting commands and expects every command to start with a forward slash ( `/` ). Running the following command will produce an error:- community.routeros.command: commands: - /ip - print
...
4. Finally, the ansible.netcommon.network_cli connection plugin uses paramiko by default to connect to devices with SSH. You can set its `ssh_type` option to`libssh` to use ansible-pylibssh instead, which offers Python bindings to libssh. See its documentation for details.
