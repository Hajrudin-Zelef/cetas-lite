---
id: collect-260926-mikrotik/mikrotik/how-to-connect-to-routeros-devices-with-ssh-2
...
dates: []
keywords: ["memory"]
source: docs/RAG/lot-mikrotik/RouterOS/how-to-connect-to-routeros-devices-with-ssh-2.md
source_anchor: ""
source_lines: [1, 96]
sha256: ff2cb3296e9c02cb6cb27bcbc3625c375eb0fbaee55a104cb0db67e8620b1f91
---
...
4. The ansible.netcommon.network_cli connection plugin uses paramiko by default to connect to devices with SSH. You can set its **ssh_type**
`libssh` to use ansible-pylibssh instead, which offers Python bindings to libssh. See its documentation for details.
