---
id: collect-260926-mikrotik/mikrotik/arborescence-des-pages-4
title: "Introduction"
domain: mikrotik
role: reference
task: reference
...
source: docs/RAG/lot-mikrotik/RouterOS/arborescence-des-pages-4.md
source_anchor: ""
source_lines: [1, 47]
sha256: 64eedf8eb1811caeb5c60b68526c3215bfb40aefeeee4822f16b15b6fa3e815a
---

# Introduction

**Sub-menu:**  `/interface gre`**Standards:** RFC1701
...
| **ipsec-secret** (*string* ; Default: )*sensitive* | When secret is specified, router adds dynamic IPsec peer to remote-address with pre-shared key and policy (by default phase2 uses sha1/aes128cbc). | 
