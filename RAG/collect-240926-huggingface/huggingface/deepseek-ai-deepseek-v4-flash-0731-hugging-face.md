---
id: collect-240926-huggingface/huggingface/deepseek-ai-deepseek-v4-flash-0731-hugging-face
title: "messages -> string"
domain: huggingface
role: reference
task: reference
actors: ["DeepSeek", "OpenAI", "SGLang", "Z.ai", "vLLM"]
dates: []
keywords: ["agent", "agentic", "agents", "attention", "benchmark", "benchmarks", "deepseek", "fp4", "fp8", "glm", "inference", "leaderboard"]
source: docs/RAG/clean_en/huggingface/deepseek-ai-deepseek-v4-flash-0731-hugging-face.md
source_anchor: ""
source_lines: [1, 98]
sha256: 71ccdffc5a96966881fccad75ba7f0dc037484507269c10fe62d05247d4bc2c0
---
...
## Spaces using deepseek-ai/DeepSeek-V4-Flash-0731 59

## Collection including deepseek-ai/DeepSeek-V4-Flash-0731

## Paper for deepseek-ai/DeepSeek-V4-Flash-0731

- datacurve/deep-swe · Deep Swe View evaluation results    leaderboard  54.4
- harborframework/terminal-bench-2.1 · Terminalbench 2 1 View evaluation results    leaderboard  82.7<sup>*</sup>
- hkust-nlp/Toolathlon · Toolathlon Verified View evaluation results     70.3
