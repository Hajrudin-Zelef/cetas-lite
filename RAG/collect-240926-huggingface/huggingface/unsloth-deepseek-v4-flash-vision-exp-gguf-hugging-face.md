---
id: collect-240926-huggingface/huggingface/unsloth-deepseek-v4-flash-vision-exp-gguf-hugging-face
title: "unsloth-deepseek-v4-flash-vision-exp-gguf-hugging-face"
domain: huggingface
role: reference
task: reference
...
source: docs/RAG/clean_en/huggingface/unsloth-deepseek-v4-flash-vision-exp-gguf-hugging-face.md
source_anchor: ""
source_lines: [1, 71]
sha256: 17416be611977e8e765f4d48af310d9a79d537c87898f9003b76769b87d1dcd8
---
...
- For the text agent benchmarks above, DeepSeek models are evaluated with the minimal mode of DeepSeek Harness as the agent framework, using the `max` reasoning effort level with`temperature = 1.0, top_p = 0.95` .
- † For ApexBench and Agents' Last Exam, DeepSeek-V4-Flash-0731 ignores the multimodal elements in the input.
