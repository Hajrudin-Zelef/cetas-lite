---
id: collect-240926-huggingface/huggingface/coherelabs-north-small-translate-1-0-hugging-face-1
title: "pip install transformers cohere_melody"
domain: huggingface
role: reference
task: reference
actors: ["China", "Cohere", "Hugging Face", "Nvidia", "vLLM"]
dates: []
keywords: ["cohere", "attention", "blackwell", "decode", "embeddings", "fp8", "gpu", "license", "memory", "nvfp4", "open weights", "parameters"]
source: docs/RAG/clean_en/huggingface/coherelabs-north-small-translate-1-0-hugging-face.md
source_anchor: ""
source_lines: [1, 151]
sha256: 3c1c72e71f7cf8ca9142e3fa08fe6b87207647cd0cbb9a55fb1e24d74934f918
---
...
Slice off the prompt and parse the remainder with Cohere's `melody` library, which is the same parser vLLM uses:
...
You can also run the model in vLLM. Accurate response parsing requires installing Cohere's `melody` library.
