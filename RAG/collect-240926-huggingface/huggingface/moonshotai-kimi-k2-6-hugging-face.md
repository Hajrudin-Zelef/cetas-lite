---
id: collect-240926-huggingface/huggingface/moonshotai-kimi-k2-6-hugging-face
title: "moonshotai-kimi-k2-6-hugging-face"
domain: huggingface
role: reference
task: reference
actors: ["Anthropic", "DeepSeek", "Google", "Moonshot", "OpenAI", "SGLang", "vLLM"]
dates: []
keywords: ["kimi", "agent", "agentic", "agents", "attention", "benchmark", "benchmarks", "claude", "context window", "decode", "deepseek", "gemini"]
source: docs/RAG/clean_en/huggingface/moonshotai-kimi-k2-6-hugging-face.md
source_anchor: ""
source_lines: [1, 300]
sha256: 5f5ebb56c037ab565ab3e4158e8ed42f1bdd38401529557c3e2a1763ac30cb6a
---
...
- Idavidrein/gpqa · Diamond View evaluation results    leaderboard  90.5
- SWE-bench/SWE-bench_Verified · Swe Bench Resolved View evaluation results    leaderboard  80.2
- ScaleAI/SWE-bench_Pro · SWE Bench Pro View evaluation results    leaderboard  58.6
- MathArena/aime_2026 · MathArena Aime 2026 View evaluation results    leaderboard  96.4
- IntelligenceLab/Long-Horizon-Terminal-Bench · Lhtb Solved View evaluation results  source  leaderboard  0<sup>*</sup>
- actava/chi-bench leaderboard
- Chi Bench View evaluation results source
