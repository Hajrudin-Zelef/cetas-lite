---
id: collect-240926-huggingface/huggingface/moonshotai-kimi-k3-hugging-face
title: "moonshotai-kimi-k3-hugging-face"
domain: huggingface
role: reference
task: reference
actors: ["Anthropic", "Fireworks AI", "Google", "Moonshot", "OpenAI", "Z.ai"]
dates: ["2026-07-09", "2026-07-16", "2026-07-23"]
keywords: ["kimi", "agent", "agentic", "agents", "attention", "benchmark", "benchmarks", "claude", "context window", "cyber", "cybersecurity", "fable 5"]
source: docs/RAG/clean_en/huggingface/moonshotai-kimi-k3-hugging-face.md
source_anchor: ""
source_lines: [1, 175]
sha256: fdc36a6c119522e45510ad759d3f52fba292aed94271ccb5ae114a0b217c632f
---
...
- datacurve/deep-swe · Deep Swe View evaluation results    leaderboard  67.5
- llamaindex/ExtractBench leaderboard
- Mean View evaluation resultssourcePipeline name: kimi_k3_extract_oneshot_structured_output_file; served via Fireworks hosted API83.17<sup>*</sup>
- Short View evaluation resultssourcePipeline name: kimi_k3_extract_oneshot_structured_output_file; served via Fireworks hosted API94.64<sup>*</sup>
- Medium View evaluation resultssourcePipeline name: kimi_k3_extract_oneshot_structured_output_file; served via Fireworks hosted API69.64<sup>*</sup>
