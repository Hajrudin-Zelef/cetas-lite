# NOTES — corpus `collect-240926-huggingface`

## Génération

Mode **files** (`RAG/_tools/build_rag.py`) : **une source = un chunk**, copie verbatim.

- source : `docs/RAG/clean_en/huggingface` (125 fichiers)
- dossier interne : `huggingface` · domaine : huggingface (100 %)
- total : ~241,914 mots

## Contenu

Hugging Face — cartes de modèles, GGUF/quantisations, benchmarks open weights.

## Titres

58 fichier(s) sur 125 n'ont pas de titre `# H1` dans la source : le titre
