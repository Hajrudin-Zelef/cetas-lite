---
id: collect-250926-servers-hardware/servers-hardware/permissions-1
title: "Permissions"
...
actors: []
dates: []
keywords: ["agent", "agents", "inference", "mcp"]
source: docs/RAG/clean4/permissions.md
source_anchor: ""
source_lines: [1, 229]
sha256: 21bb14179a9ec4dbb1e452e1e847fb2ac0f3db560a2abfa337199394fca02338
---
...
```
Agent rules are appended after global rules; they do not replace the global array. A custom subagent uses its own permissions, not a subset of its parentâs permissions.
...
| Allow always | `always` | Approve it and save the toolâs proposed patterns for the project | 
