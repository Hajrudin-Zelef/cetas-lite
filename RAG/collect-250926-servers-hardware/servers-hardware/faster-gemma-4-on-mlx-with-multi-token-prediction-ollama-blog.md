---
id: collect-250926-servers-hardware/servers-hardware/faster-gemma-4-on-mlx-with-multi-token-prediction-ollama-blog
...
dates: ["2026-06-29"]
keywords: ["agent", "agents", "benchmark", "claude", "copilot", "cost", "decode", "gpu", "nvfp4", "prefill", "speculative decoding", "tokens per second"]
source: docs/RAG/clean4/faster-gemma-4-on-mlx-with-multi-token-prediction-ollama-blog.md
source_anchor: ""
source_lines: [1, 51]
sha256: 07c188d793d3dc311cd2fc979af9a59f471c71d169ea7443d2886ed61dc558ef
---
...
Then use `ollama launch` to launch a coding agent powered by Gemma 4:
