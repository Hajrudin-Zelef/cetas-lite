---
id: collect-250926-servers-hardware/servers-hardware/attachments
title: "Attachments"
...
actors: []
dates: []
keywords: ["multimodal", "parameters"]
source: docs/RAG/clean4/attachments.md
source_anchor: ""
source_lines: [1, 113]
sha256: 5d9715a437a89398ac2314934aa83b412e5526421764fc7d2633fe7d9b801c9e
---
...
Desktop file-picker selections can total up to 20 MiB. Other interfaces may apply lower client-side limits.
...
```
HTTP and HTTPS attachment URLs are not supported. See the generated API reference for programmatic prompt submission.
...
```
Input:  4000 Ã 2000 WebP
Limits: 2000 Ã 2000
Output: 2000 Ã 1000 PNG or JPEG
```
...
```
Input:  2400 Ã 1600 JPEG
Limit:  max_width = 2000, auto_resize = false
Result: Image processing fails
```
If the image resizer is unavailable, OpenCode passes the original image through unchanged. Image settings are therefore processing limits, not an upload or security boundary.
...
A client accepting a file does not guarantee that its contents reach the model. The attachment must use a model-visible format and satisfy both OpenCode and provider limits.
