# NOTES — corpus `collect-240926-korben`

## Génération

Mode **files** (`RAG/_tools/build_rag.py`) : **une source = un chunk**, copie verbatim.

- source : `docs/RAG/clean_en/korben` (18 fichiers)
- dossier interne : `korben` · domaine : korben (100 %)
- total : ~12,040 mots

## Contenu

Korben.info — veille IA & tech grand public, veille open source.

## Titres

0 fichier(s) sur 18 n'ont pas de titre `# H1` dans la source : le titre
