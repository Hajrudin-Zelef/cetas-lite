...
Corpus `etape7-phasei-media` · **16 fichiers** · 750 lignes source · ~9240 mots · partition exacte de `docs/RAG/etape7_phaseI_media.md`.
...
|---|---|---|---|---|
| 01 | [Step 7 — Phase I: Media Servers, Transcoding and Upscaling](00-front-matter/overview.md) | 1–89 | reference | model-release |
| 02 | [2. FFmpeg and the hardware-encoder landscape](00-front-matter/2-ffmpeg-and-the-hardware-encoder-landscape.md) | 90–149 | reference | hardware |
| 03 | [4. Transcoder configurations (Jellyfin / Plex / Emby)](00-front-matter/4-transcoder-configurations-jellyfin-plex-emby.md) | 150–200 | reference | model-release |
| 04 | [7. Audio: passthrough and transcoding](00-front-matter/7-audio-passthrough-and-transcoding.md) | 201–261 | reference | model-release |
| 05 | [10. Decision guides](00-front-matter/10-decision-guides.md) | 262–306 | reference | model-release |
| 06 | [14.1 Jellyfin internals worth knowing](00-front-matter/14-1-jellyfin-internals-worth-knowing.md) | 307–362 | reference | model-release |
| 07 | [14.5 SVT-AV1 command patterns](00-front-matter/14-5-svt-av1-command-patterns.md) | 363–410 | reference | model-release |
| 08 | [14.9 *arr stack reference deployment](00-front-matter/14-9-arr-stack-reference-deployment.md) | 411–455 | reference | model-release |
| 09 | [14.11 Transcode troubleshooting matrix](00-front-matter/14-11-transcode-troubleshooting-matrix.md) | 456–506 | reference | model-release |
| 10 | [14.16 Intro Skipper tuning](00-front-matter/14-16-intro-skipper-tuning.md) | 507–556 | reference | model-release |
...
- **Apple** (7) — [00-front-matter/overview.md](00-front-matter/overview.md), [00-front-matter/2-ffmpeg-and-the-hardware-encoder-landscape.md](00-front-matter/2-ffmpeg-and-the-hardware-encoder-landscape.md), [00-front-matter/7-audio-passthrough-and-transcoding.md](00-front-matter/7-audio-passthrough-and-transcoding.md), [00-front-matter/10-decision-guides.md](00-front-matter/10-decision-guides.md), [00-front-matter/14-5-svt-av1-command-patterns.md](00-front-matter/14-5-svt-av1-command-patterns.md), [00-front-matter/14-11-transcode-troubleshooting-matrix.md](00-front-matter/14-11-transcode-troubleshooting-matrix.md), [05-strip-global-metadata-that-confuses-some-clients/overview.md](05-strip-global-metadata-that-confuses-some-clients/overview.md)
...
- **Samsung** (4) — [00-front-matter/overview.md](00-front-matter/overview.md), [00-front-matter/10-decision-guides.md](00-front-matter/10-decision-guides.md), [00-front-matter/14-11-transcode-troubleshooting-matrix.md](00-front-matter/14-11-transcode-troubleshooting-matrix.md), [05-strip-global-metadata-that-confuses-some-clients/overview.md](05-strip-global-metadata-that-confuses-some-clients/overview.md)
...
- **2026-09-22** — [00-front-matter/overview.md](00-front-matter/overview.md), [00-front-matter/10-decision-guides.md](00-front-matter/10-decision-guides.md), [05-strip-global-metadata-that-confuses-some-clients/15-line-count-and-qc-attestation.md](05-strip-global-metadata-that-confuses-some-clients/15-line-count-and-qc-attestation.md)

## Carte de couverture (lignes source)

| plage | fichier |
|---|---|
| 1–89 | etape7-phasei-media/00-front-matter/overview.md |
| 90–149 | etape7-phasei-media/00-front-matter/2-ffmpeg-and-the-hardware-encoder-landscape.md |
