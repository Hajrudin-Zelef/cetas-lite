...
role: deep-dive
task: actor-profile
actors: ["Groq", "Hugging Face", "Intel", "Nvidia"]
dates: ["2025-08-25", "2025-12-19", "2026-03", "2026-04-17", "2026-05-31", "2026-06-01", "2026-06-03", "2026-07", "2026-07-20", "2026-07-21", "2026-07-27", "2026-08-05", "2026-08-06", "2026-08-11", "2026-08-12", "2026-08-14", "2026-08-22"]
keywords: ["agent", "agentic", "agents", "benchmarks", "blackwell", "cost", "datacenter", "disaggregated", "distillation", "fp4", "fp8", "gguf"]
source: docs/RAG/ai-industry-knowledge-base-2026-wave6.md
source_anchor: ""
source_lines: [7724, 7798]
section: "§15. NVIDIA and Nemotron"
sha256: 76f85330cf0d5b2b800115eed82668ea376977a5c684d355287eaffa3e3b1eb1
---
...
- [S41] Medium (aman kohli): NVIDIA Dynamo — the missing layer for scaling generative AI inference (Apr 2026) — https://medium.com/@aman.kohli1/nvidia-dynamo-the-missing-layer-for-scaling-generative-ai-inference-2a5b8f557045
- [S42] GitHub mirror: swipe4057/dynamo — datacenter-scale distributed inference serving framework (features, runtimes) — https://github.com/swipe4057/dynamo
- [S43] NVIDIA Newsroom: NVIDIA announces major release of Cosmos WFMs and physical AI data tools — http://nvidianews.nvidia.com/news/nvidia-announces-major-release-of-cosmos-world-foundation-models-and-physical-ai-data-tools
- [S44] QuantumZeitgeist: NVIDIA introduces breakthrough Cosmos WFMs (Transfer/Predict/Reason) — http://quantumzeitgeist.com/nvidia-introduces-breakthrough-cosmos-world-foundation-models-for-physical-ai-and-synthetic-data-generation/
- [S45] GitHub: eivholt/edgeai-synthetic-cosmos-transfer — Cosmos Reason/Predict/Transfer family notes — https://github.com/eivholt/edgeai-synthetic-cosmos-transfer
- [S46] TechTarget: NVIDIA's new model aims to move GenAI to physical world (20M hours video training) — https://www.techtarget.com/ai/news/366617551/Nvidias-new-model-aims-to-move-GenAI-to-physical-world
- [S47] Robotics247/Lanner: EAI-I351 robotic AI platform with NVIDIA Jetson Thor — https://www.robotics247.com/article/lanner-electronics-unveils-eai-i351-robotic-ai-platform-powered-by-nvidia-jetson-thor-blackwell
- [S48] Auvidea press release: NVIDIA Jetson Thor T5000 launch — X242 carrier board (same form factor as AGX Orin, >98% power efficiency via GaN MOSFETs), 2070 FP4 TFLOPS, 128GB, 130W — https://auvidea.eu/press-release-nvidia-jetson-thor-t5000-launch/
- [S49] DataCamp: Nemotron 3.5 Lightning features & benchmarks (30B/3B, Aug 11 2026, 4x speed, OpenMDW-1.1, SWE-bench Verified 51.56 / PinchBench 85.37) — https://www.datacamp.com/blog/nemotron-3-5-lightning
- [S50] Intel neural-compressor docs: NVFP4 quantization format (E2M1, 16-element blocks, FP8 E4M3 block scale, FP32 per-tensor scale) — https://github.com/intel/neural-compressor/blob/HEAD/docs/source/PT_NVFP4Quant.md
- [S51] VentureBeat: NVIDIA's Switchyard router reshuffles AI models mid-task (2026-08-11) — https://venturebeat.com/orchestration/nvidias-switchyard-router-reshuffles-ai-models-mid-task-cutting-task-costs-to-a-third-in-its-own-tests
- [S52] SiliconANGLE: NVIDIA releases Nemotron 3.5 Lightning + NeMo Switchyard (2026-08-11) — https://siliconangle.com/2026/08/11/nvidia-releases-nemotron-3-5-lightning-nemo-switchyard-give-enterprise-ai-capability-options/
- [S53] Awesome Agents: NVIDIA Cosmos 3 model card (Nano 16B / Super 64B, MoT, benchmarks, adopters, Cosmos Coalition) — https://awesomeagents.ai/models/nvidia-cosmos-3/
- [S54] RunAIHome: Cosmos 3 Nano local-AI hardware guide (May 31/Jun 1 dates, 8B+8B, Nano-Policy-DROID, RTX PRO 6000) — https://runaihome.com/blog/nvidia-cosmos-3-nano-local-ai-hardware-guide-2026/
- [S55] NVIDIA Developer Forums: Isaac GR00T N1.7 early access announcement (2026-04-17, commercial licensing, finger-level dexterity) — https://forums.developer.nvidia.com/t/early-access-isaac-gr00t-n1-7-open-reasoning-vla-model-for-humanoid-robotics/366916
- [S56] BitcoinEthereumNews: NVIDIA launches Nemotron 3 and GR00T N1.7 (LG/NEURA adoption, N2 preview 2x claim, MolmoSpaces/RoboArena, year-end availability) — https://bitcoinethereumnews.com/tech/nvidia-launches-nemotron-3-and-gr00t-n1-7-open-models-for-ai-agents-and-robotics/
- [S57] AItechtonic: NVIDIA Alpamayo 2 Super powers next-gen autonomous driving (34B VLA, Cosmos 3 Super Reasoner, OpenMDW-1.1, 115k hours / 3.7M CoC) — http://aitechtonic.com/nvidia-alpamayo-2-super/
- [S58] NVIDIA Newsroom: NVIDIA launches Alpamayo 2 Super open reasoning model for robotaxis (2026-05-31) — https://nvidianews.nvidia.com/news/nvidia-alpamayo-2-super-robotaxis
