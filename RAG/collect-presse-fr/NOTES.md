# NOTES — corpus `collect-presse-fr`

## Génération

Mode **`files`** (`RAG/_tools/build_rag.py`) : **une fiche = un chunk**, copiée verbatim
de `docs/RAG/Collect RAG/05_presse_fr`. Chaque fiche suit le template `_TEMPLATE.md` de la collecte (titre H1,
...
presse FR — 8 fiches collectées le 2026-09-23, statut ✅ reachable sauf
