...
CORPORA = [
    ...
    },
    {
        ...
        "mode": "auto", "max_lines": 90, "min_lines": 45, "first_is_content": True, "folder_name": "news-tech",
        "actors": KB_ACTORS, "terms": KB_TERMS, "anchor_label": "(aucune ancre source)",
    },
    {
        "slug": "etape10-phaseb-news-mobile",
        "title": "Step 10 — Phase B: Mobile & Devices News (February → September 2026)",
        "source": "docs/RAG/etape10_phaseB_news_mobile.md",
        "mode": "auto", "max_lines": 90, "min_lines": 45, "first_is_content": True, "folder_name": "news-mobile",
        "actors": KB_ACTORS, "terms": KB_TERMS, "anchor_label": "(aucune ancre source)",
    },
    {
        "slug": "etape10-phasec-news-pc-mac",
        "title": "Step 10 Phase C — PC & Mac News (February → September 2026)",
        "source": "docs/RAG/etape10_phaseC_news_pc_mac.md",
        "mode": "auto", "max_lines": 90, "min_lines": 45, "first_is_content": True, "folder_name": "news-pc-mac",
        "actors": KB_ACTORS, "terms": KB_TERMS, "anchor_label": "(aucune ancre source)",
    },
    {
        "slug": "etape10-phased-news-sport",
        "title": "Step 10D — Sports News (February 2026 → 22 September 2026)",
        "source": "docs/RAG/etape10_phaseD_news_sport.md",
        "mode": "auto", "max_lines": 90, "min_lines": 45, "first_is_content": True, "folder_name": "news-sport",
        "actors": KB_ACTORS, "terms": KB_TERMS, "anchor_label": "(aucune ancre source)",
    },
    {
        "slug": "etape10-phasee-news-world",
        "title": "Etape 10E — World News: Wars, Geopolitics, Elections, Economy, Fortunes (February 2026 – 22 September 2026)",
        "source": "docs/RAG/etape10_phaseE_news_world.md",
        "mode": "auto", "max_lines": 90, "min_lines": 45, "first_is_content": True, "folder_name": "news-world",
        "actors": KB_ACTORS, "terms": KB_TERMS, "anchor_label": "(aucune ancre source)",
    },
    {
        "slug": "etape10-phasef-news-buzz",
        "title": "STEP 10 — Phase F: News, Buzz & Society (2026-02-01 → 2026-09-22)",
        "source": "docs/RAG/etape10_phaseF_news_buzz.md",
        "mode": "auto", "max_lines": 90, "min_lines": 45, "first_is_content": True, "folder_name": "news-buzz",
        "actors": KB_ACTORS, "terms": KB_TERMS, "anchor_label": "(aucune ancre source)",
    },
    {
        "slug": "etape10-phaseg-news-science",
        "title": "Step 10 Phase G — Science & Planet News (February → September 2026)",
        "source": "docs/RAG/etape10_phaseG_news_science.md",
        "mode": "auto", "max_lines": 90, "min_lines": 45, "first_is_content": True, "folder_name": "news-science",
        "actors": KB_ACTORS, "terms": KB_TERMS, "anchor_label": "(aucune ancre source)",
    },
    {
        "slug": "etape6-phasea-vendors-dc",
    ...
    {
        "slug": "etape6-phaseb-smb-networking",
        "title": "Step 6 Extension — Phase B: SMB / Prosumer Networking",
        "source": "docs/RAG/etape6_phaseB_smb_networking.md",
        "mode": "auto", "max_lines": 90, "min_lines": 45,
        "actors": KB_ACTORS, "terms": KB_TERMS, "anchor_label": "(aucune ancre source)",
    },
    {
        "slug": "etape6-phasec-optics-cabling",
    ...
    {
        "slug": "etape6-phased1-fabrics-spine-leaf",
        ...
        "mode": "auto", "max_lines": 90, "min_lines": 45, "first_is_content": True, "folder_name": "fabrics-spine-leaf",
        "actors": KB_ACTORS, "terms": KB_TERMS, "anchor_label": "(aucune ancre source)",
    },
    {
        "slug": "etape6-phased2-evpn-vxlan",
        "title": "Step 6 — Phase D wave 2: EVPN-VXLAN overlay",
        "source": "docs/RAG/etape6_phaseD2_evpn_vxlan.md",
        "mode": "auto", "max_lines": 90, "min_lines": 45, "first_is_content": True, "folder_name": "evpn-vxlan",
        "actors": KB_ACTORS, "terms": KB_TERMS, "anchor_label": "(aucune ancre source)",
    },
    {
        "slug": "etape6-phased3-bgp-ha",
        "title": "Phase D3 — BGP underlay and high availability in the data center",
        "source": "docs/RAG/etape6_phaseD3_bgp_ha.md",
        "mode": "auto", "max_lines": 90, "min_lines": 45, "first_is_content": True, "folder_name": "bgp-ha",
        "actors": KB_ACTORS, "terms": KB_TERMS, "anchor_label": "(aucune ancre source)",
    },
    {
        "slug": "etape6-phased4-segmentation-qos-multicast",
        ...
        "mode": "auto", "max_lines": 90, "min_lines": 45, "first_is_content": True, "folder_name": "segmentation-qos-multicast",
        "actors": KB_ACTORS, "terms": KB_TERMS, "anchor_label": "(aucune ancre source)",
    },
    {
        "slug": "etape6-phasee1-netbox-nautobot",
        "title": "Phase E1 — NetBox & Nautobot: Network Source of Truth (Research File)",
        "source": "docs/RAG/etape6_phaseE1_netbox_nautobot.md",
        "mode": "auto", "max_lines": 90, "min_lines": 45, "first_is_content": True, "folder_name": "netbox-nautobot",
        "actors": KB_ACTORS, "terms": KB_TERMS, "anchor_label": "(aucune ancre source)",
    },
    {
        "slug": "etape6-phasee2-ansible-nornir-terraform",
    ...
    {
        "slug": "etape6-phasee3-gnmi-openconfig-telemetry",
        ...
        "mode": "auto", "max_lines": 90, "min_lines": 45, "first_is_content": True, "folder_name": "gnmi-openconfig-telemetry",
        "actors": KB_ACTORS, "terms": KB_TERMS, "anchor_label": "(aucune ancre source)",
    },
    {
        "slug": "etape6-phasee4-validation-cicd",
    ...
    {
        "slug": "etape6-phasef1-nic-dpu-smartnic",
        ...
        "mode": "auto", "max_lines": 90, "min_lines": 45, "first_is_content": True, "folder_name": "nic-dpu-smartnic",
        "actors": KB_ACTORS, "terms": KB_TERMS, "anchor_label": "(aucune ancre source)",
    },
    {
        "slug": "etape6-phasef2-fpga",
        "title": "Phase F2 — FPGA (Field-Programmable Gate Arrays)",
        "source": "docs/RAG/etape6_phaseF2_fpga.md",
        "mode": "auto", "max_lines": 90, "min_lines": 45, "first_is_content": True, "folder_name": "fpga",
        "actors": KB_ACTORS, "terms": KB_TERMS, "anchor_label": "(aucune ancre source)",
    },
    {
        "slug": "etape6-phasef3-platform-security",
        "title": "Step 6 Phase F3 — Platform Firmware & Hardware Root of Trust",
        "source": "docs/RAG/etape6_phaseF3_platform_security.md",
        "mode": "auto", "max_lines": 90, "min_lines": 45, "first_is_content": True, "folder_name": "platform-security",
        "actors": KB_ACTORS, "terms": KB_TERMS, "anchor_label": "(aucune ancre source)",
    },
    {
        "slug": "etape6-phasef4-virtualization-io",
        "title": "Phase F4 — I/O Virtualization & CPU Acceleration Extensions",
        "source": "docs/RAG/etape6_phaseF4_virtualization_io.md",
        "mode": "auto", "max_lines": 90, "min_lines": 45, "first_is_content": True, "folder_name": "virtualization-io",
        "actors": KB_ACTORS, "terms": KB_TERMS, "anchor_label": "(aucune ancre source)",
    },
    {
        "slug": "etape7-phasea-os",
        "title": "Step 7 — Phase A: Server Operating Systems (Linux OS Layer)",
        "source": "docs/RAG/etape7_phaseA_os.md",
        "mode": "auto", "max_lines": 90, "min_lines": 45, "first_is_content": True, "folder_name": "os",
        "actors": KB_ACTORS, "terms": KB_TERMS, "anchor_label": "(aucune ancre source)",
    },
    {
        "slug": "etape7-phaseb-containers",
        "title": "Step 7 — Phase B: Containers, Orchestration & Sandbox Runtimes",
        "source": "docs/RAG/etape7_phaseB_containers.md",
        "mode": "auto", "max_lines": 90, "min_lines": 45, "first_is_content": True, "folder_name": "containers",
        "actors": KB_ACTORS, "terms": KB_TERMS, "anchor_label": "(aucune ancre source)",
    },
    {
        "slug": "etape7-phasec-iac",
        "title": "Step 7 Phase C — IaC & Platform Automation",
        "source": "docs/RAG/etape7_phaseC_iac.md",
        "mode": "auto", "max_lines": 90, "min_lines": 45, "first_is_content": True, "folder_name": "iac",
        "actors": KB_ACTORS, "terms": KB_TERMS, "anchor_label": "(aucune ancre source)",
    },
    {
        "slug": "etape7-phased-proxmox-backup",
        "title": "Step 7 — Phase D: Proxmox VE, Virtualization Platforms & Backup — Research",
        "source": "docs/RAG/etape7_phaseD_proxmox_backup.md",
        "mode": "auto", "max_lines": 90, "min_lines": 45, "first_is_content": True, "folder_name": "proxmox-backup",
        "actors": KB_ACTORS, "terms": KB_TERMS, "anchor_label": "(aucune ancre source)",
    },
    {
        "slug": "etape7-phasee-storage-software",
        ...
        "mode": "auto", "max_lines": 90, "min_lines": 45, "first_is_content": True, "folder_name": "storage-software",
        "actors": KB_ACTORS, "terms": KB_TERMS, "anchor_label": "(aucune ancre source)",
    },
    {
        "slug": "etape7-phasef-databases",
        "title": "Step 7 — Phase F: Databases & Cache (Operations Angle)",
        "source": "docs/RAG/etape7_phaseF_databases.md",
        "mode": "auto", "max_lines": 90, "min_lines": 45, "first_is_content": True, "folder_name": "databases",
        "actors": KB_ACTORS, "terms": KB_TERMS, "anchor_label": "(aucune ancre source)",
    },
    {
        "slug": "etape7-phaseg-linuxnet-vpn",
        ...
        "mode": "auto", "max_lines": 90, "min_lines": 45, "first_is_content": True, "folder_name": "linuxnet-vpn",
        "actors": KB_ACTORS, "terms": KB_TERMS, "anchor_label": "(aucune ancre source)",
    },
    {
        "slug": "etape7-phaseh-webproxy",
        "title": "Step 7 — Phase H: Web Servers, Reverse Proxies & API Gateways",
        "source": "docs/RAG/etape7_phaseH_webproxy.md",
        "mode": "auto", "max_lines": 90, "min_lines": 45, "first_is_content": True, "folder_name": "webproxy",
        "actors": KB_ACTORS, "terms": KB_TERMS, "anchor_label": "(aucune ancre source)",
    },
    {
        "slug": "etape7-phasei-media",
    ...
    {
        "slug": "etape8-phasea-system-languages",
        "title": "Step 8 — Phase A: Systems Languages",
        "source": "docs/RAG/etape8_phaseA_system_languages.md",
        "mode": "auto", "max_lines": 90, "min_lines": 45, "first_is_content": True, "folder_name": "system-languages",
        "actors": KB_ACTORS, "terms": KB_TERMS, "anchor_label": "(aucune ancre source)",
    },
    {
        "slug": "etape8-phaseb-web-mobile-languages",
        "title": "Step 8 — Phase B — Web & Mobile Languages, Runtimes and Toolchains",
        "source": "docs/RAG/etape8_phaseB_web_mobile_languages.md",
        "mode": "auto", "max_lines": 90, "min_lines": 45, "first_is_content": True, "folder_name": "web-mobile-languages",
        "actors": KB_ACTORS, "terms": KB_TERMS, "anchor_label": "(aucune ancre source)",
    },
    {
        "slug": "etape8-phasec-backend-frameworks",
        "title": "Step 8 — Phase C: Backend Frameworks & APIs",
        "source": "docs/RAG/etape8_phaseC_backend_frameworks.md",
        "mode": "auto", "max_lines": 90, "min_lines": 45, "first_is_content": True, "folder_name": "backend-frameworks",
        "actors": KB_ACTORS, "terms": KB_TERMS, "anchor_label": "(aucune ancre source)",
    },
    {
        "slug": "etape8-phased-frontend",
        "title": "Step 8 — Phase D: Frontend & Web Platform (Dev Angle)",
        "source": "docs/RAG/etape8_phaseD_frontend.md",
        "mode": "auto", "max_lines": 90, "min_lines": 45, "first_is_content": True, "folder_name": "frontend",
        "actors": KB_ACTORS, "terms": KB_TERMS, "anchor_label": "(aucune ancre source)",
    },
    {
        "slug": "etape8-phasee-aiml-stacks",
        "title": "Step 8, Phase E — AI/ML Software Stacks (Developer-Facing)",
        "source": "docs/RAG/etape8_phaseE_aiml_stacks.md",
        "mode": "auto", "max_lines": 90, "min_lines": 45, "first_is_content": True, "folder_name": "aiml-stacks",
        "actors": KB_ACTORS, "terms": KB_TERMS, "anchor_label": "(aucune ancre source)",
    },
    {
        "slug": "etape8-phasef-data-messaging",
    ...
    {
        "slug": "etape9-phasea-enterprise-ssd",
        "title": "Step 9 — Enterprise SSD Hardware (Phase A)",
        "source": "docs/RAG/etape9_phaseA_enterprise_ssd.md",
        "mode": "auto", "max_lines": 90, "min_lines": 45, "first_is_content": True, "folder_name": "enterprise-ssd",
        "actors": KB_ACTORS, "terms": KB_TERMS, "anchor_label": "(aucune ancre source)",
    },
    {
        "slug": "etape9-phaseb-form-factors-interfaces",
        ...
        "mode": "auto", "max_lines": 90, "min_lines": 45, "first_is_content": True, "folder_name": "form-factors-interfaces",
        "actors": KB_ACTORS, "terms": KB_TERMS, "anchor_label": "(aucune ancre source)",
    },
    {
        "slug": "etape9-phasec-memory",
        "title": "Step 9 — Phase C: Server & Accelerator Memory Hardware",
        "source": "docs/RAG/etape9_phaseC_memory.md",
        "mode": "auto", "max_lines": 90, "min_lines": 45, "first_is_content": True, "folder_name": "memory",
        "actors": KB_ACTORS, "terms": KB_TERMS, "anchor_label": "(aucune ancre source)",
    },
    {
        "slug": "etape9-phased-data-protection-raid",
        "title": "Step 9 — Phase D: Data Protection & RAID Hardware",
        "source": "docs/RAG/etape9_phaseD_data_protection_raid.md",
        "mode": "auto", "max_lines": 90, "min_lines": 45, "first_is_content": True, "folder_name": "data-protection-raid",
        "actors": KB_ACTORS, "terms": KB_TERMS, "anchor_label": "(aucune ancre source)",
    },
    {
        "slug": "etape9-phasee-storage-market",
