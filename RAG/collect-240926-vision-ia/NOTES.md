# NOTES — corpus `collect-240926-vision-ia`

## Génération

Mode **files** (`RAG/_tools/build_rag.py`) : **une source = un chunk**, copie verbatim.

- source : `docs/RAG/clean_en/vision-ia` (55 fichiers)
- dossier interne : `vision-ia` · domaine : vision-ia (100 %)
- total : ~145,542 mots

## Contenu

Vision-IA — newsletter quotidienne IA (beehiiv) : actus, modèles, Géo.

## Titres

0 fichier(s) sur 55 n'ont pas de titre `# H1` dans la source : le titre
