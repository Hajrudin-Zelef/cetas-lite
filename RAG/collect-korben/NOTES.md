# NOTES — corpus `collect-korben`

## Génération

Mode **`files`** (`RAG/_tools/build_rag.py`) : **une fiche = un chunk**, copiée verbatim
de `docs/RAG/Collect RAG/01_korben`. Chaque fiche suit le template `_TEMPLATE.md` de la collecte (titre H1,
...
Korben.info — 18 fiches collectées le 2026-09-23, statut ✅ reachable sauf
