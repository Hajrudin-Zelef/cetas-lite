		...
		},
		{
			...
			Modes: []Mode{
				...
				{ID: "autotest", Label: "Auto", Agent: true, Rule: "zen gratuits en tirage aleatoire, puis Pareto en repli",
					...
					// Pareto reste uniquement en repli : le pool est melange,
					// l'y ajouter le ferait tirer (et facturer) avant les
					// gratuits, et creerait un doublon avec ce repli.
					Fallback: []Member{
						{"openrouter", "openrouter/pareto-code"},
					}},
				{ID: "flash", Label: "Flash", Agent: true, Rule: "deepseek v4.1 flash + pool opencode/opencode-go + openrouter",
					Pool: []Member{
				...
				{ID: "standard", Label: "Standard", Agent: true, Rule: "pool opencode-go + openrouter",
					Pool: []Member{
				...
				{ID: "elite", Label: "Elite", Agent: true, Rule: "deepseek v4 pro + pool opencode/opencode-go + openrouter",
					Pool: []Member{
