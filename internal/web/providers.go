...
// providerInfo decrit un provider cloud. Les cles ne sont jamais exposees,
// meme chiffrees. (Les moteurs SamGen ont leur propre namespace
// /api/local/engines, logique separee.)
...
// handleProvidersList retourne les providers cloud connus avec leur etat de
...
func (s *Server) handleProvidersList(w http.ResponseWriter, r *http.Request) {
	...
	out := make([]providerInfo, 0, len(provider.CloudProviderIDs()))
