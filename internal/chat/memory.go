...
func MemoryToolSchemas() []provider.Tool {
	...
	return []provider.Tool{
		{Type: "function", Function: provider.ToolFunction{Name: "mem_search", Description: "Search your persistent memory pages. Returns files, titles and excerpts.", Parameters: str(map[string]any{
			"query": map[string]any{"type": "string"},
			"limit": map[string]any{"type": "integer", "description": "Default 8, max 30"},
		}, "query")}},
		{Type: "function", Function: provider.ToolFunction{Name: "mem_read", Description: "Read a memory page, numbered, with offset/limit.", Parameters: str(map[string]any{
		...
		{Type: "function", Function: provider.ToolFunction{Name: "mem_add", Description: "Create a memory page (fails if it exists).", Parameters: str(map[string]any{
