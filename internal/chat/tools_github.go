...
func githubToolSchemas() []provider.Tool {
	...
	return []provider.Tool{
		{Type: "function", Function: provider.ToolFunction{Name: "GitHubRepos", Description: "List your GitHub repositories (authenticated user), most recently updated first. Read-only.", Parameters: str(map[string]any{
			"limit": limit,
		})}},
		{Type: "function", Function: provider.ToolFunction{Name: "GitHubIssues", Description: "List issues of a GitHub repository. Read-only.", Parameters: str(map[string]any{
			"owner": owner, "repo": repo, "state": state, "limit": limit,
		}, "owner", "repo")}},
		{Type: "function", Function: provider.ToolFunction{Name: "GitHubIssueGet", Description: "Get a GitHub issue with its comments. Read-only.", Parameters: str(map[string]any{
			"owner": owner, "repo": repo, "number": number,
		}, "owner", "repo", "number")}},
		{Type: "function", Function: provider.ToolFunction{Name: "GitHubPRs", Description: "List pull requests of a GitHub repository. Read-only.", Parameters: str(map[string]any{
			"owner": owner, "repo": repo, "state": state, "limit": limit,
		}, "owner", "repo")}},
		{Type: "function", Function: provider.ToolFunction{Name: "GitHubRepoCreate", Description: "Create a GitHub repository on your account. Needs approval.", Parameters: str(map[string]any{
		...
		{Type: "function", Function: provider.ToolFunction{Name: "GitHubIssueCreate", Description: "Create a GitHub issue. Needs approval.", Parameters: str(map[string]any{
		...
		{Type: "function", Function: provider.ToolFunction{Name: "GitHubIssueComment", Description: "Comment on a GitHub issue (or pull request). Needs approval.", Parameters: str(map[string]any{
			"owner": owner, "repo": repo, "number": number,
			"body": map[string]any{"type": "string", "description": "Comment body (markdown)"},
		}, "owner", "repo", "number", "body")}},
		{Type: "function", Function: provider.ToolFunction{Name: "GitHubPRCreate", Description: "Create a GitHub pull request. Needs approval.", Parameters: str(map[string]any{
			"owner": owner, "repo": repo,
		...
		{Type: "function", Function: provider.ToolFunction{Name: "GitHubPRMerge", Description: "Merge a GitHub pull request. Needs approval.", Parameters: str(map[string]any{
			"owner": owner, "repo": repo, "number": number,
