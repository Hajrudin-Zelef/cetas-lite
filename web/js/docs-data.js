      ...
      articles: [
        ...
        },
        {
          ...
          sections: [
            ...
            { h: "Quel modèle choisir ?", html: `<p>Pour discuter, un modèle léger suffit. Pour du code ou des missions complexes, préférez une version <em>standard/elite</em>. Vous pouvez changer d'alias à chaque message sans casser le fil de la discussion. Le <strong>menu +</strong> liste les alias (Nano, N4, SamGen) : survolez un alias pour ouvrir son sous-menu — <strong>Auto (fallback)</strong> (tout l'alias en tirage aléatoire), puis chaque version avec sa sélection effective (<em>Modèle — [nom]</em> ou <em>Fallback · N modèles</em>). Dans <strong>Configuration → Sélecteur de modèles</strong>, réglez chaque version sur <strong>1 modèle</strong> (fixe) ou <strong>Fallback</strong> (tirage aléatoire à chaque requête).</p>` },
          ],
        },
        {
          id: "premier-message",
