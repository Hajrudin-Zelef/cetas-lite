      ...
      articles: [
        ...
        },
        {
          ...
          sections: [
            ...
            { h: "Traduire le raisonnement (DeepThink Global)", html: `<p>Le raisonnement s'affiche souvent en anglais. Le bouton <strong>🌐 Traduire</strong>, dans l'en-tête <strong>REASONING</strong> du panneau latéral, le traduit via un petit modèle dédié ; un second clic revient au texte original.</p><p>La langue cible (<strong>ES / FR / IT / DE / EN</strong>) et le modèle traducteur (<strong>openrouter/free</strong> ou <strong>DeepSeek V3.2</strong> via le provider DeepSeek) se règlent dans l'onglet <strong>DeepThink Global</strong> des paramètres.</p>` },
          ],
        },
        {
          id: "tokens-couts",
