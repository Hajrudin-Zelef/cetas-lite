    ...
    },
    {
      ...
      articles: [
        ...
        },
        {
          ...
          sections: [
            { h: "Afficher le raisonnement", html: `<p>Le bouton <strong>Thinking</strong> demande au modèle d'exposer son raisonnement avant de répondre. Dans le chat, il est désactivé par défaut ; dans la vue Agents, il est toujours actif.</p><p>Le raisonnement s'affiche dans un panneau latéral dédié, en temps réel pendant la génération : en haut, les informations de la requête (modèle, temps de génération, tokens d'entrée, tokens de sortie et débit, contexte utilisé, coût estimé), puis le raisonnement sous l'en-tête <strong>REASONING</strong>.</p><p>Quand le raisonnement est terminé, le panneau se masque automatiquement. Pour le reconsulter, cliquez le bouton <strong>Raisonnement</strong> affiché au-dessus de votre message.</p>` },
