...
//
// Harness  : rendu DeepSeek Harness (lignes d'outils compactes "✨ Tool
//            call · Nom · hint", loader Marex, statuts tours/outils/tokens).
...
export const AGENTIC_STYLES = [AGENTIC_STYLE_HARNESS, AGENTIC_STYLE_OPENCODE];
